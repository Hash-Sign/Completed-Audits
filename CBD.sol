...
Every transaction consumes your $CBD:
2% auto distributed back to $CBD holders
2% auto added back to CBD/BNB PancakeSwap pool
2% sent to a designated charity wallet (denominated in BNB)
2% sent to a designated marketing wallet (denominated in BNB)
