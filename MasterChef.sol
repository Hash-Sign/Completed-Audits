...
// File @openzeppelin/contracts/token/ERC20/SafeERC20.sol@v3.0.0
...
// File @openzeppelin/contracts/token/ERC20/ERC20.sol@v3.0.0
...
contract MasterChef is Ownable {
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        if(_amount > 0) {
            ...
            if(pool.depositFeeBP > 0){
                ...
                uint256 burnFee = depositFee.mul(5000).div(10000);
                uint256 devFee = depositFee.sub(burnFee);
    ...
    function burn(address _burnAddress) public onlyOwner {
        burnAddress = _burnAddress;
    }
